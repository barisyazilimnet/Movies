...
namespace Movies {
    ...
    public partial class DbMoviesDataSet : global::System.Data.DataSet {
        ...
        public partial class MoviesDataTable : global::System.Data.TypedTableBase<MoviesRow> {
            ...
            [global::System.Diagnostics.DebuggerNonUserCodeAttribute()]
            [global::System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "17.0.0.0")]
            public MoviesRow AddMoviesRow(string Name, bool IsDownloaded, string Type, string Link) {
            ...
            private void InitClass() {
                ...
                this.columnIsDownloaded.AllowDBNull = false;
        ...
        public partial class MoviesRow : global::System.Data.DataRow {
            ...
            public bool IsDownloaded {
                get {
                    return ((bool)(this[this.tableMovies.IsDownloadedColumn]));
                }
                set {
                    this[this.tableMovies.IsDownloadedColumn] = value;
                }
            }
...
namespace Movies.DbMoviesDataSetTableAdapters {
    ...
    public partial class MoviesTableAdapter : global::System.ComponentModel.Component {
        ...
        private void InitAdapter() {
            ...
            this._adapter.DeleteCommand.CommandText = "DELETE FROM [dbo].[Movies] WHERE (([Id] = @Original_Id) AND ([Name] = @Original_N" +
                "ame) AND ([IsDownloaded] = @Original_IsDownloaded) AND ([Type] = @Original_Type)" +
                ")";
            ...
            this._adapter.InsertCommand.CommandText = "INSERT INTO [dbo].[Movies] ([Name], [IsDownloaded], [Type], [Link]) VALUES (@Name" +
                ", @IsDownloaded, @Type, @Link);\r\nSELECT Id, Name, IsDownloaded, Type, Link FROM " +
            ...
            this._adapter.UpdateCommand.CommandText = @"UPDATE [dbo].[Movies] SET [Name] = @Name, [IsDownloaded] = @IsDownloaded, [Type] = @Type, [Link] = @Link WHERE (([Id] = @Original_Id) AND ([Name] = @Original_Name) AND ([IsDownloaded] = @Original_IsDownloaded) AND ([Type] = @Original_Type));
SELECT Id, Name, IsDownloaded, Type, Link FROM Movies WHERE (Id = @Id)";
        ...
        private void InitConnection() {
            ...
            this._connection.ConnectionString = global::Movies.Properties.Settings.Default.DbMoviesConnectionString;
        }
        ...
        private void InitCommandCollection() {
            ...
            this._commandCollection[0].CommandText = "SELECT Id, Name, IsDownloaded, Type, Link FROM dbo.Movies";
        ...
        public virtual int Fill(DbMoviesDataSet.MoviesDataTable dataTable) {
        ...
        public virtual DbMoviesDataSet.MoviesDataTable GetData() {
            this.Adapter.SelectCommand = this.CommandCollection[0];
            DbMoviesDataSet.MoviesDataTable dataTable = new DbMoviesDataSet.MoviesDataTable();
        ...
        [global::System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "17.0.0.0")]
        [global::System.ComponentModel.Design.HelpKeywordAttribute("vs.data.TableAdapter")]
        public virtual int Update(DbMoviesDataSet.MoviesDataTable dataTable) {
        ...
        public virtual int Delete(int Original_Id, string Original_Name, bool Original_IsDownloaded, string Original_Type) {
            ...
            this.Adapter.DeleteCommand.Parameters[2].Value = ((bool)(Original_IsDownloaded));
        ...
        public virtual int Insert(string Name, bool IsDownloaded, string Type, string Link) {
            if ((Name == null)) {
            ...
            this.Adapter.InsertCommand.Parameters[1].Value = ((bool)(IsDownloaded));
            if ((Type == null)) {
        ...
        public virtual int Update(string Name, bool IsDownloaded, string Type, string Link, int Original_Id, string Original_Name, bool Original_IsDownloaded, string Original_Type, int Id) {
            if ((Name == null)) {
                throw new global::System.ArgumentNullException("Name");
            }
            else {
            ...
            this.Adapter.UpdateCommand.Parameters[1].Value = ((bool)(IsDownloaded));
            if ((Type == null)) {
                throw new global::System.ArgumentNullException("Type");
            }
            else {
            ...
            this.Adapter.UpdateCommand.Parameters[6].Value = ((bool)(Original_IsDownloaded));
            if ((Original_Type == null)) {
                throw new global::System.ArgumentNullException("Original_Type");
            }
            else {
        ...
        [global::System.ComponentModel.Design.HelpKeywordAttribute("vs.data.TableAdapter")]
        [global::System.ComponentModel.DataObjectMethodAttribute(global::System.ComponentModel.DataObjectMethodType.Update, true)]
        public virtual int Update(string Name, bool IsDownloaded, string Type, string Link, int Original_Id, string Original_Name, bool Original_IsDownloaded, string Original_Type) {
            return this.Update(Name, IsDownloaded, Type, Link, Original_Id, Original_Name, Original_IsDownloaded, Original_Type, Original_Id);
        }
    }
